...
//                                         sx={{ px: 3, py: 1.5, '&:hover': { bgcolor: 'rgba(139,92,246,0.12)' } }}
//                                     >
//                                         <ListItemText
//                                             primary={
...
//             const rawPhone = (userData?.phoneNumber ?? '').replace(/^\+?260/, '');
...
//     // Attach an existing vehicle to this driver
//     const handleAttachExistingVehicle = async (vehicle) => {
//         setError(null);
//         setSavingStep('attachExisting', true);
//         try {
//             if (isDeliveryDriver) {
//                 // Set vehicle type then attach via delivery onboarding
//                 await apiClient.post('/delivery-driver/onboarding/vehicle-type', {
//                     vehicleType: vehicle.vehicleType ?? selectedVehicleType,
//                     driverId,
//                 });
//                 await apiClient.post('/delivery-driver/onboarding/vehicle-details', {
//                     existingVehicleId: vehicle.id,
//                     vehicleType: vehicle.vehicleType ?? selectedVehicleType,
//                     driverId,
//                 });
//             } else {
//                 // For ride drivers, assign the vehicle directly on the driver profile
//                 await apiClient.put(`/driver-profiles/${driverProfileId}`, {
