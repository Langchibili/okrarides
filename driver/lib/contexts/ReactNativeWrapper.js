...
//             checkTimeoutRef.current = null;
//           }
//           console.log('ℹ️ Running in web browser (not React Native)');
//         }
//       }
//     };
...
//       console.log('📍 Navigated to frontend:', newFrontend);
//     };
...
//       console.log('⚠️ Native services already initialized');
//       return { success: true, reason: 'already_initialized' };
//     }

//     try {
//       console.log(`🚀 Initializing native services for ${frontendName}...`);
