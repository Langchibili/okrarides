...
// PATH: Okra/Okrarides/driver/components/Map/APIProviders/GoogleMapsProvider.jsx
//
// Updated from original driver version:
//  - searchPlaces: switched to Autocomplete (New) API with correct field names
//    (radius not radiusMeters, structuredFormat for clean main/secondary text)
//  - getPlaceDetails: switched from Place Details ($17/1k) to Geocoding API ($5/1k)
//  - getRoute: added using Routes API ($5/1k) with strict Essentials field mask
//  - All methods accept optional apiMethod for MapsProvider dispatch pattern
//  - Viewport bias via setViewport() so autocomplete matches what's visible on map
