...
//     // Validate documents and photos only for new vehicles
//     if (!isEditMode) {
//       // Check required documents
//       if (!uploadedDocs.registrationDocument) {
//         setError('Vehicle registration document is required')
//         return false
//       }
...
//         setError('Road tax certificate is required')
//         return false
//       }

//       if (isFitnessDocumentRequired && !uploadedDocs.fitnessDocument) {
//         setError('Fitness certificate is required')
//         return false
//       }
...
//         setError(`Please upload all vehicle photos (${missingPhotos.join(', ')})`)
//         return false
//       }
//     }
...
//         })
//       } else {
//         // Add new vehicle with documents and photos
//         response = await addVehicle({
//           ...vehicleData,
//           registrationDocument: uploadedDocs.registrationDocument?.id || uploadedDocs.registrationDocument,
//           insuranceCertificate: uploadedDocs.insuranceCertificate?.id || uploadedDocs.insuranceCertificate,
//           roadTaxCertificate: uploadedDocs.roadTaxCertificate?.id || uploadedDocs.roadTaxCertificate,
//           fitnessDocument: uploadedDocs.fitnessDocument?.id || uploadedDocs.fitnessDocument,
//           vehiclePhotos: photosArray,
//         })
//       }
...
//           const updatedResponse = await getVehicleDetails()
...
//           }
//         } else {
//           // Redirect to verification page after adding vehicle
//           router.push('/verification')
//         }
//       } else {
//         setError(response.error || `Failed to ${isEditMode ? 'update' : 'add'} vehicle`)
//       }
//     } catch (err) {
...
//                 onRemove={() =>
//                   setUploadedDocs((prev) => ({ ...prev, registrationDocument: null }))
//                 }
//               />
//             </Box>
...
//                   onRemove={() =>
//                     setUploadedDocs((prev) => ({ ...prev, roadTaxCertificate: null }))
//                   }
//                 />
//               </Box>
//             )}
...
//                 After submitting your vehicle for verification, you will temporarily not
//                 receive orders until we approve the vehicle. This typically takes 24-48
//                 hours.
//               </Typography>
//             </Alert>
...
//               {loading
//                 ? 'Adding Vehicle...'
//                 : 'Add Vehicle & Submit for Verification'}
//             </Button>
//           </form>
//         )}
//       </Box>
      ...
      <Box sx={{ p: 3 }}>
        ...
        {!isEditMode && (
          <form onSubmit={handleSubmit}>
            ...
            {/* Documents and Photos - Only show after basic info is saved */}
            {hasBasicInfoSaved && (
              <>
                {/* Vehicle Documents */}
                <Typography variant="h6" sx={{ fontWeight: 600, mb: 2 }}>
