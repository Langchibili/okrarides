...
//   // ── Shared label for insurance status chip ───────────────────────────────
...
//   return (
//     <Box sx={{ height: '100vh', overflowY: 'auto', bgcolor: 'background.default', pb: 10 }}>
//       {/* Header */}
//       <Box
//         sx={{
//           p: 2,
...
//         {/* ── Existing Vehicle Summary (enhanced) ── */}
//         {isEditMode && existingVehicle && (
//           <Paper
//             elevation={0}
//             sx={{
...
//                   }}
//                 >
//                 {/* Number plate — full width, prominent */}
//                 <Grid item xs={12}>
//                   <Box
//                     sx={{
...
//                     sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2.5, fontFamily: 'monospace', fontWeight: 700, letterSpacing: 1 } }}
//                   />
//                 </Grid>
...
//                     onChange={handleMakeChange}
//                     renderInput={(params) => (
//                       <TextField {...params} label="Make" placeholder="e.g., Toyota" required
//                         sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2.5 } }}
//                       />
//                     )}
//                   />
...
//                     renderInput={(params) => (
//                       <TextField {...params} label="Model" placeholder="e.g., Corolla" required
//                         sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2.5 } }}
//                       />
//                     )}
//                   />
...
//         {/* Documents and Photos - disabled hint */}
//         {!hasBasicInfoSaved && !isEditMode && (
