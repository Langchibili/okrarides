...
// //       {/* Map */}
// //       <Box sx={{ flex:1, position:'relative' }}>
// //         <MapIframe center={getMapCenter()} zoom={15} height="100%"
...
//   const markers = [];
//   if (driverLocation)
//     markers.push({ id: 'driver',  position: driverLocation,       type: 'driver',  icon: '🚗', animation: 'BOUNCE' });
//   if (ride?.pickupLocation)
//     markers.push({ id: 'pickup',  position: ride.pickupLocation,  type: 'pickup',  icon: '📍' });
//   if (ride?.dropoffLocation && (rideStatus === 'passenger_onboard' || rideStatus === 'awaiting_payment'))
//     markers.push({ id: 'dropoff', position: ride.dropoffLocation, type: 'dropoff', icon: '🎯' });
...
//           onMapLoad={(c) => { mapControlsRef.current = c; }}
//         />
//         <Fab color="primary" sx={{ position:'absolute', bottom:16, right:16 }} onClick={handleNavigate}>
//           <NavigationIcon />
//         </Fab>
//       </Box>
...
//                 </Box>
//               </Box>
//               <IconButton onClick={handleMessageRider} sx={{ bgcolor:'primary.light', '&:hover':{ bgcolor:'primary.main', color:'white' } }}>
//                 <MessageIcon />
//               </IconButton>
//             </Box>
//           </Paper>
