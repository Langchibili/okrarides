...
import { getImageUrl, savedCurrencyCode, savedCurrencySymbol, savedPhoneCode } from '@/Functions';
...
export default function AffiliateDashboard() {
  ...
  const rate = data?.conversionRate ?? { ratePerPoint: 0.1, currencySymbol: savedCurrencySymbol(), currencyCode: savedCurrencyCode(), affiliatePoints: 1, currencyAmount: 0.1 };
