...
//     { id: 'affiliates', name: 'Okra Affiliates',  desc: 'Build your network, grow your income', icon: '💸', gradient: 'linear-gradient(145deg,#14532d 0%,#15803d 55%,#22c55e 100%)', glowColor: 'rgba(22,163,74,0.20)', accentDot: '#bbf7d0', url: '#',                      features: ['Refer a driver, earn', 'Earn per customer trip', 'Withdraw via mobile money'] },
//   ];
