...
const OkraLandingPage = () => {
  ...
  const fetchFrontendUrls = async () => {
    try {
      ...
      setFrontendUrls({
        riderApp: urls['okra-rider-app'] || 'http://10.225.83.23:3001/home',
        driverApp: urls['okra-driver-app'] || 'http://10.225.83.23:3002/home',
      ...
      setFrontendUrls({
        riderApp: 'http://10.225.83.23:3001/home',
        driverApp: 'http://10.225.83.23:3002/home',
