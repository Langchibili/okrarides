// // PATH: Okra/Okrarides/delivery/components/Map/APIProviders/MapsProvider.jsx
...
export function MapsProvider({ children }) {
  ...
  // ── Provider resolution — returns { name, instance, record, apiMethod } ───
  ...
  const resolveServiceProvider = useCallback((explicitName, serviceType, failedSet = new Set()) => {
    ...
    if (explicitName && isUsable(explicitName)) return toEntry(explicitName);
