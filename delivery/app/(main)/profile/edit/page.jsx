'use client';
// PATH: app/(main)/profile/edit/page.jsx — UI POLISH ONLY
import { useState, useEffect } from 'react';
import { useRouter } from 'next/navigation';
import { Box, AppBar, Toolbar, Typography, IconButton, TextField, Button, Avatar, Paper, Grid, MenuItem, Alert } from '@mui/material';
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.07 }}>
            <Paper elevation={0} sx={{
              ...
              <Button type="submit" fullWidth variant="contained" size="large" disabled={loading}
                sx={{ mt: 3, height: 56, borderRadius: 3, fontWeight: 700,
                  background: isDark
