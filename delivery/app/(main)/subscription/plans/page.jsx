...
import { formatCurrency, savedCurrencyCode } from '@/Functions';
                      ...
                      <Paper elevation={isDark ? 0 : plan.isPopular ? 4 : 2} sx={{
                        ...
                        {plan.isPopular && (
                          <Chip label="⭐ Most Popular" size="small"
                            sx={{
                              position: 'absolute', top: 14, right: 14, fontWeight: 700, height: 24,
                        ...
                        {plan.hasFreeTrial && (
                          <Box sx={{
                            mb: 1.5, p: 1.25, borderRadius: 2, bgcolor: alpha(accent, isDark ? 0.15 : 0.07),
                        ...
                        {plan.hasFreeTrial && !currentSubscription && (
                          <Button fullWidth variant="outlined" size="large"
                            ...
                            sx={{
                              mb: 1, height: 48, borderRadius: 3, fontWeight: 700, textTransform: 'none',
                  ...
                  {[
                    ...
                    <Grid item xs={6} key={label}>
                      <Box sx={{ display: 'flex', gap: 1.25 }}>
                        <Box sx={{
                          width: 36, height: 36, borderRadius: 2, bgcolor: alpha(color, isDark ? 0.18 : 0.1),
