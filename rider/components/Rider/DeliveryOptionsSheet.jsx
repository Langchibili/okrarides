// 'use client';
// // PATH: components/Rider/DeliveryOptionsSheet.jsx
// //
// // Full delivery booking sheet. Replaces RideOptionsSheet for delivery flows.
// //
// // Flow:
// //   1. Delivery mode   — "Deliver to someone" | "Deliver with me"
// //   2. Recipient info  — name + phone (only if "Deliver to someone")
// //   3. Package type    — Package / Big Item / Cargo
// //      Package  → ask fragile?
// //      Big Item → ask weight + fits in car | needs truck
// //      Cargo    → no extra questions
// //   4. Deliver by      — optional vehicle type preference
// //   5. Estimates       — fetched from backend, shown as cards
// //   6. Payment method
// //   7. Confirm
...
//   animation: 'deliveryHeaderWave 7s ease infinite',
//   '@keyframes deliveryHeaderWave': {
...
//         bgcolor: selected ? `rgba(245,158,11,0.07)` : 'background.paper',
...
// function VehicleChip({ value, Icon, label, selected, onClick }) {
//   return (
//     <Chip
//       icon={<Icon sx={{ fontSize: 16, color: selected ? '#fff' : 'text.secondary' }} />}
//       label={label}
//       onClick={onClick}
...
//         '&:hover': { bgcolor: selected ? AMBER2 : `rgba(245,158,11,0.08)` },
//       }}
//     />
//   );
// }
...
//     if (packageType === 'big_item') return !!(itemWeight && bigItemFit);
//     return true;
//   })();
...
//                 bgcolor: deliveryMode === value ? `rgba(245,158,11,0.07)` : 'background.paper',
...
//               borderRadius: 2.5, bgcolor: isFragile ? 'rgba(239,68,68,0.05)' : 'background.paper',
...
//                     bgcolor: bigItemFit === value ? `rgba(245,158,11,0.07)` : 'background.paper',
//                     borderRadius: 2.5, transition: 'all 0.14s',
...
//                   onClick={() => setVehiclePreference(p => p === value ? null : value)}
//                 />
//               ))}
//             </Box>
//             {vehiclePreference && (
...
//                       bgcolor: isSelected ? 'rgba(245,158,11,0.07)' : 'background.paper',
//                       borderRadius: 2.5, transition: 'all 0.14s',
...
//                     bgcolor: paymentMethod === value ? 'rgba(245,158,11,0.07)' : 'background.paper',
//                     borderRadius: 2.5, transition: 'all 0.14s',
//                     display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 0.75,
//                     '&:hover': { borderColor: AMBER },
//                   }}
...
//               bgcolor: 'background.paper', width: '100%', boxSizing: 'border-box',
//             }}>
//               {/* Fare breakdown */}
//               <Box sx={{ mb: 1.5 }}>
