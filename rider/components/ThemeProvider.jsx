...
//   // ── Notify native layer on every mode or color change ─────────────────────
//   // Fires after every commit where mode/color changed so the native shell
//   // (status bar, navigation bar, etc.) can sync its chrome.
//   useEffect(() => {
...
//    *
//    * @example
//    * setTheme('dark', '#FF5722')   // switch to dark with a custom colour
//    * setTheme('light')             // switch to light, keep existing colour
//    */
...
//     setMode,
//     setColor,
//     /** Alias for setColor — change the accent colour from any page. */
