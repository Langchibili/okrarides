...
export const API_ENDPOINTS = {
  ...
  DELIVERIES: {
    BASE:     '/deliveries',
    ESTIMATE: '/deliveries/estimate',
    TRACK:    (id) => `/deliveries/${id}/track`,
    CANCEL:   (id) => `/deliveries/${id}/cancel`,
    RATE:     '/ratings',
  },
...
// Map Configuration
export const MAP_CONFIG = {
  DEFAULT_CENTER: { lat: -15.4167, lng: 28.2833 },
  DEFAULT_ZOOM: 13,
  MIN_ZOOM: 10,
  MAX_ZOOM: 20,
  BOUNDS: { north: -8.2, south: -18.1, west: 21.9, east: 33.7 },
  COLORS: {
    PICKUP:    '#4CAF50',
    DROPOFF:   '#F44336',
    ROUTE:     '#2196F3',
...
export const TIME = {
  ...
  DAY:                  24 * 60 * 60 * 1000,
  OTP_RESEND_DELAY:     30,
  SESSION_DURATION:     6 * 30 * 24 * 60 * 60 * 1000,
  RIDE_REQUEST_TIMEOUT: 30,
};
...
// Rating Tags
export const RATING_TAGS = {
  POSITIVE: ['Great Service', 'Clean Vehicle', 'Safe Driving', 'Friendly', 'On Time', 'Professional'],
  NEGATIVE: ['Late', 'Rude Behavior', 'Unsafe Driving', 'Dirty Vehicle', 'Wrong Route', 'Unprofessional'],
};
...
export default {
  ...
  RIDE_STATUS, RIDE_STATUS_LABELS, RIDE_STATUS_COLORS,
  SOCKET_EVENTS,
  PAYMENT_METHODS, PAYMENT_METHOD_LABELS,
  RIDE_TYPES, RIDE_TYPE_LABELS,
  MAP_CONFIG, STORAGE_KEYS, TIME, VALIDATION,
  ERROR_MESSAGES, SUCCESS_MESSAGES,
  NOTIFICATION_TYPES, RATING_TAGS, FEATURES,
};